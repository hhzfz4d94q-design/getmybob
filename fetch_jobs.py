...
<div id="wiz3-overlay" role="dialog" aria-modal="true" aria-labelledby="wiz3-h2">
  <div id="wiz3-card">
    ...
    <section id="wiz3-main" style="position:relative;">
      ...
      <header id="wiz3-head">
        <div class="wiz3-step-no" id="wiz3-step-no">Step 1 of 12</div>
...
(function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      subtitle: "Edit any chips that don't reflect what you actually want to do.",
      optional: true,
      render(body) {
        body.innerHTML =
          '<p>The AI extracted titles, industries, skills, and target companies from your resume. Open the Profile tab to review and tweak.</p>' +
          '<button type="button" class="wiz3-btn wiz3-btn-ghost" id="wiz3-open-profile">Open Profile editor</button>' +
          '<p style="font-size:12px;color:#888;margin-top:12px;">Add or remove chips so the job matcher knows what you want. Come back here when you\'re done.</p>';
        const btn = body.querySelector("#wiz3-open-profile");
        if (btn) btn.addEventListener("click", () => {
          try { if (typeof openResumeModal === "function") openResumeModal(); } catch (e) {}
          setTimeout(() => {
